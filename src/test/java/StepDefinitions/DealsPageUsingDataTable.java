...
//
//public class DealsPageUsingDataTable {
//	WebDriver driver;
//
...
//		driver.findElement(By.xpath("//input[@placeholder='Login']")).sendKeys(data.get(0));
//		driver.findElement(By.xpath("//input[@placeholder='Password']")).sendKeys(data.get(1));
//
//	}
//
...
//	public void user_provide_deal_deatails(DataTable data) {
//		//List<String> datas=data.row(0);
//
//		List<String> datas = data.asList();
//		driver.findElement(By.id("title")).sendKeys(datas.get(0));
//		driver.findElement(By.id("amount")).sendKeys(datas.get(1));
//		driver.findElement(By.id("probability")).sendKeys(datas.get(2));
//		driver.findElement(By.id("commission")).sendKeys(datas.get(3));
